...
const Themes = () => {
      ...
      return sortedProducts
        .filter((product) => {
          if (!sizeOption) {
            ...
            return (
              product.season === 'winter' && product.sizes[sizeOption] != 0
            );
          }
        })
        .map((product, index) => (
      ...
      return sortedProducts
        .filter((product) => {
          if (!sizedarkOption) {
            ...
            return (
              product.season === 'summer' && product.sizes[sizedarkOption] != 0
            );
          }
        })
        .map((product, index) => (
  ...
  return (
    <div className='d-flex flex-column mt-5'>
      <div style={{ paddingBottom: 100 }} id='winter'>
        <div
          className='pb-4 mb-3'
          style={{
      ...
      <div style={{ paddingBottom: 100 }} id='summer'>
        <div
          className='pb-4 mb-3'
          style={{
            fontFamily: 'merriweather',
